...
function show_items_in_cart($itemsInCart) {
    foreach ($itemsInCart as $item) {
        ...
        echo '        <div id="product_id_' . $id . '_div" class="' . CART_ITEM_CLASS . ' ' . CARD_CLASS . '">' . "\n";
...
function show_footer_content() {
    ...
    echo '            <ul>' . "\n";
    echo '                <li><a id="' . FACEBOOK_ID . '" class="' . ICON_CLASS . '" href="' . FACEBOOK_PAGE_URL . '"><img src="' . IMAGE_FOLDER .
        SOCIAL_FOLDER . FACEBOOK_ICON . '" alt="' . FACEBOOK_ICON_ALT . '"></a></li>' . "\n";
    echo '                <li><a id="' . X_ID . '" class="' . ICON_CLASS . '" href="' . TWITTER_PAGE_URL . '"><img src="' . IMAGE_FOLDER .
        SOCIAL_FOLDER . X_ICON . '" alt="' . X_ICON_ALT . '"></a></li>' . "\n";
    echo '                <li><a id="' . INSTAGRAM_ID . '" class="' . ICON_CLASS . '" href="' . INSTAGRAM_PAGE_URL . '"><img src="' .
        IMAGE_FOLDER . SOCIAL_FOLDER . INSTAGRAM_ICON . '" alt="' . INSTAGRAM_ICON_ALT . '"></a></li>' . "\n";
    echo '                <li><a id="' . PINTEREST_ID . '" class="' . ICON_CLASS . '" href="' . PINTEREST_PAGE_URL . '"><img src="' . IMAGE_FOLDER .
